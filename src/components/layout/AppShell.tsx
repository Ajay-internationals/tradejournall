...
export function AppShell() {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-[var(--app-bg)] text-[var(--app-text)] transition-all duration-500 font-body">
            ...
            <header className="fixed top-0 left-0 right-0 h-20 bg-white/60 dark:bg-indigo-950/40 backdrop-blur-3xl border-b border-indigo-500/10 z-[90] flex items-center justify-between px-8 lg:px-12 shadow-2xl transition-all duration-500 ring-1 ring-indigo-500/5">
            ...
            <main className="flex-1 overflow-y-auto pt-20 ml-80 no-scrollbar bg-[var(--app-bg)]">
