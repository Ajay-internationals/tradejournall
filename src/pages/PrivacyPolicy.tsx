        ...
        <div className="min-h-screen bg-white text-slate-900 selection:bg-indigo-500/30 font-body">
            ...
            <div className="pt-40 pb-20 px-6 max-w-4xl mx-auto font-body">
                ...
                <div className="prose prose-slate max-w-none space-y-8 font-medium text-slate-600 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-wider">1. Information Collection</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-wider">2. Use of Information</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-wider">3. Data Security</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-wider">4. Contact Us</h2>
