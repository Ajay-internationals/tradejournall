            ...
            <div className="pt-40 pb-20 px-6 max-w-4xl mx-auto font-body">
                ...
                <div className="prose prose-slate max-w-none space-y-8 font-medium text-slate-600 leading-relaxed">
                    <section className="p-8 bg-rose-50 border border-rose-100 rounded-3xl">
                        <h2 className="text-xl font-black text-rose-900 mb-4 uppercase tracking-wider">No Refunds Policy</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-wider">Subscription Cancellation</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-wider">Exceptional Circumstances</h2>
