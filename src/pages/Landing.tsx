    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 selection:bg-indigo-500/30 overflow-x-hidden font-body">
            ...
            <div className="bg-slate-900 py-3 px-6 text-center group cursor-pointer" onClick={() => navigate('/webinar')}>
                <p className="text-[10px] md:text-sm font-bold font-heading text-white uppercase tracking-[0.2em] flex items-center justify-center gap-4">
                    <Sparkles className="w-4 h-4 text-amber-400 animate-pulse" />
                    Free Beginner Webinar this Sunday at 11 AM - <span className="text-indigo-400 group-hover:underline italic">Register Now</span>
                    <Sparkles className="w-4 h-4 text-amber-400 animate-pulse" />
                </p>
            </div>
